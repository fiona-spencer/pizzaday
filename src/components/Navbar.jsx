...
import letterlogo from "../assets/letter-logo-white.png";
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link 
          ...
          >
          <img src={letterlogo} alt="logo" style={{width: "50px"}}/>
          <p className="text-white text-[18px] font-bold cursor-pointer flex"
          >Fiona <span className="sm:block hidden">&nbsp;| Three JS Portfolio</span></p>
        </Link>
